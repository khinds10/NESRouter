...
#include "megaman.h"
#include "metroid.h"
#include "metroidhome.h"
#include "mushroom.h"
#include "samus.h"
#include "simon.h"
#include "superluigi.h"
#include "supermario.h"
#include "supermario3.h"
#include "tank.h"
#include "themetroid.h"
#include "triforce.h"
#include "zelda.h"
#include "zelda2.h"
...
int main (int argc, char* argv[]) {
    ...
    } else if (strcmp(digoleCommand, "boxSprite") == 0) {
        drawBitmap256(0, 0, 128, 128, &boxSprite,0);
    } else if (strcmp(digoleCommand, "castlevaniaSprite") == 0) {
        drawBitmap256(0, 0, 128, 128, &castlevaniaSprite,0);
    } else if (strcmp(digoleCommand, "fireflowerSprite") == 0) {
        drawBitmap256(0, 0, 128, 128, &fireflowerSprite,0);
    } else if (strcmp(digoleCommand, "linkSprite") == 0) {
        drawBitmap256(0, 0, 128, 128, &linkSprite,0);
    } else if (strcmp(digoleCommand, "luigiSprite") == 0) {
        drawBitmap256(0, 0, 128, 128, &luigiSprite,0);
    } else if (strcmp(digoleCommand, "marioSprite") == 0) {
        drawBitmap256(0, 0, 128, 128, &marioSprite,0);
    } else if (strcmp(digoleCommand, "megamanSprite") == 0) {
        drawBitmap256(0, 0, 128, 128, &megamanSprite,0);
    } else if (strcmp(digoleCommand, "metroidSprite") == 0) {
        drawBitmap256(0, 0, 128, 128, &metroidSprite,0);
    } else if (strcmp(digoleCommand, "metroidhomeSprite") == 0) {
        drawBitmap256(0, 0, 128, 128, &metroidhomeSprite,0);
    } else if (strcmp(digoleCommand, "mushroomSprite") == 0) {
        drawBitmap256(0, 0, 128, 128, &mushroomSprite,0);
    } else if (strcmp(digoleCommand, "samusSprite") == 0) {
        drawBitmap256(0, 0, 128, 128, &samusSprite,0);
    } else if (strcmp(digoleCommand, "simonSprite") == 0) {
        drawBitmap256(0, 0, 128, 128, &simonSprite,0);
    } else if (strcmp(digoleCommand, "superluigiSprite") == 0) {
        drawBitmap256(0, 0, 128, 128, &superluigiSprite,0);
    } else if (strcmp(digoleCommand, "supermarioSprite") == 0) {
        drawBitmap256(0, 0, 128, 128, &supermarioSprite,0);
    } else if (strcmp(digoleCommand, "supermario3Sprite") == 0) {
        drawBitmap256(0, 0, 128, 128, &supermario3Sprite,0);
    } else if (strcmp(digoleCommand, "tankSprite") == 0) {
        drawBitmap256(0, 0, 128, 128, &tankSprite,0);
    } else if (strcmp(digoleCommand, "themetroidSprite") == 0) {
        drawBitmap256(0, 0, 128, 128, &themetroidSprite,0);
    } else if (strcmp(digoleCommand, "triforceSprite") == 0) {
        drawBitmap256(0, 0, 128, 128, &triforceSprite,0);
    } else if (strcmp(digoleCommand, "zeldaSprite") == 0) {
        drawBitmap256(0, 0, 128, 128, &zeldaSprite,0);
    } else if (strcmp(digoleCommand, "zelda2Sprite") == 0) {
        drawBitmap256(0, 0, 128, 128, &zelda2Sprite,0);
    }    
    printf("\n");
	return 0;
}
